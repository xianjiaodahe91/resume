...
\begin{itemize}
  \item Based on life cycle / utility APIs, based on each languages' built-in GUI framework,
    easy to install.
  \item GitHub issue / milestone are used as task / version managing tools, nice changelogs.
...
\begin{itemize}
  ...
  \item About one-twentieth of Java's (Hotspot 8u151) performance in benchmark testing.
  \item A development kit, a command-line REPL with code completion, and extension APIs.
\end{itemize}
...
\datedline{\textbf{1 kyu} on
  ...
  ranked \#28, primarily in Haskell}{Aug. 2017}
